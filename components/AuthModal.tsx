  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (supabase) {
        ...
        throw new Error("Supabase is not configured. Please add keys to .env.local.");
      }
    } catch (err: any) {
      setErrorMsg(err.message || "Google sign-in failed. Please verify Google OAuth settings.");
    } finally {
